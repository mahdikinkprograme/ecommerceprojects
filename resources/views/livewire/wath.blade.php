...
use App\Models\cart;
 ?>
      ...
      <!--<div class="cart" id="cart">
            ...
            @php $total = 0; @endphp
            @foreach((array)session('carts') as $getcart => $prods)
                    ...
                    <div class="cart__details">
                        ...
                        <div class="cart__amount">
                            <div class="cart__amount-content quantity">
                                <span class="cart__amount-box changqtys  chang"  data-cartid ="{{$prods['prod_id']}}"
                                data-cardqty = "{{$prods['prod_qty']}}">
                                    <i class='bx bx-minus'></i>
                                </span> 
                                <span class="cart__amount-number qty-input"  value = "{{$prods['prod_qty']}}">{{$prods['prod_qty']}}</span>
                                <span class="cart__amount-box changqty  chang" data-cardqty = "{{$prods['prod_qty']}}" data-cartid ="{{$prods['prod_id']}}">
                                    <i class='bx bx-plus'></i>
                                </span>
                            </div>
                           <i class='bx bx-trash-alt cart__amount-trash delcart' data-cart="{{$prods['id']}}"   href="javascript:void(0)"></i>
                    </div>
                </article> 
            </div>
            ...
            <div class="cart__prices">
                ...
                <span class="cart__prices-total" id="total">{{$total}}</span>     
            </div>
        </div>-->
            ...
            <section class="featured section container" id="featured">
                ...
                @foreach ($datavalue as $data)
                    <article class="featured__card ">
                        ...
                        <button class="button featured__button"><a href="" style="color:#fff">add to cart</a></button>
                    </article>
                    @endforeach
                </div>
            </section>
            ...
            <section class="products section container" id="products">
                ...
                <div class="products__container grid">
                    <article class="products__card">
                        <img src="{{asset('admin/img/')}}" alt="" class="products__img">

                        <h3 class="products__title">watch</h3>
                        <span class="products__price">$190</span>
